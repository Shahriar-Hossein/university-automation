...
$post_data['success_url'] = "http://localhost/sms/students/pages/payment.php?" . http_build_query(['status' => 1, 'user_id'=>$user_id]);
$post_data['fail_url'] = "http://localhost/sms/students/pages/payment.php?" . http_build_query(['status' => 0, 'user_id'=>$user_id]);
$post_data['cancel_url'] = "http://localhost/sms/students/pages/payment.php?" . http_build_query(['status' => -1, 'user_id'=>$user_id]);
